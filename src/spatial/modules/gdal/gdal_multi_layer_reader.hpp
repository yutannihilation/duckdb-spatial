...
public:
	GDALMultiLayerReaderOptions() = default;

	GDALOptions options;
};

struct GDALMultiLayerInfo : public MultiFileReaderInterface {
...
class GDALMultiLayerReader : public BaseFileReader {
	GDALMultiLayerReader(ClientContext &context, const OpenFileInfo &file, GDALMultiLayerReaderOptions options,
